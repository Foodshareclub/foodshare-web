...
import { getAllProducts, getProductById, getProductLocations, getProducts, getUserProducts } from "@/lib/data/products";
...
describe("Products Data Functions", () => {
  ...
  describe("getProductById", () => {
    it("removes exact location aliases from public product data", async () => {
      ...
      expect(result).toMatchObject({ latitude: location?.coordinates[1], longitude: location?.coordinates[0] });
    });
