...
export const siteConfig = {
  ...
  // Points to dynamically generated OG image (from opengraph-image.tsx)
...
export const defaultMetadata: Metadata = {
  ...
  // Note: og:image is auto-generated by opengraph-image.tsx files
  openGraph: {
    type: "website",
    locale: "en_US",
    url: siteConfig.url,
  ...
  // Twitter / X Cards
  // Note: twitter:image is auto-generated by twitter-image.tsx files
  twitter: {
