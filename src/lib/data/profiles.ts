...
export interface ProfileReview {
  ...
  comment: string;
  created_at: string;
  reviewer: { first_name: string | null; second_name: string | null; avatar_url: string | null } | null;
}
  ...
  return unstable_cache(
    async (): Promise<ProfileReview[]> => {
      ...
      return (data ?? []).map(review => ({
        ...
        reviewer: extractFirst(review.reviewer as Array<{ first_name: string | null; second_name: string | null; avatar_url: string | null }>),
      }));
    },
