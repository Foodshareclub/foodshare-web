...
const HiOutlineShieldCheck = ShieldCheck;
const HiOutlineCog = Settings;
const HiOutlineChevronRight = ChevronRight;
const HiOutlineSparkles = Sparkles;
const HiOutlineBell = Bell;
const HiOutlineGlobe = Globe;
const HiOutlineHeart = Heart;
const HiOutlineArrowRightOnRectangle = LogOut;
