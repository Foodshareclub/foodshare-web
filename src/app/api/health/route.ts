...
const MAINTENANCE_MESSAGE =
  "We're sprucing things up! Back shortly — thanks for your patience! 💚";
...
async function checkUpgradeStatus(): Promise<{
  ...
  try {
    ...
    const isUpgrading = data.status && 
      !['COMPLETED', 'FAILED', 'CANCELLED'].includes(data.status.toUpperCase());
...
/**
 * Check direct database connectivity
 */
