...
function ServiceStatusIcon({
  ...
  switch (status) {
    ...
    case 'degraded':
      return <FiLoader className="h-4 w-4 text-amber-500 animate-spin" />;
    default:
      return <FiLoader className="h-4 w-4 text-gray-400" />;
  }
}
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 space-y-4">
      ...
      {lastChecked && (
        <p className="text-xs text-gray-400 text-center">
          {t('lastChecked', { fallback: 'Last checked' })}:{' '}
