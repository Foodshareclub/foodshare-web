...
export function ReportPostDialog({ postId, postName, trigger, onReported }: ReportPostDialogProps) {
  const t = useTranslations("Reports");
    ...
    >
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            {postName
              ? t("reportPostDescription", { name: postName })
              : t("reportPostDescriptionGeneric")}
          </DialogDescription>
        </DialogHeader>
