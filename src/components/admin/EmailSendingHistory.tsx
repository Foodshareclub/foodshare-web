...
import type { EmailLogEntry, QueuedEmailEntry } from "@/types/email-management.types";

// Re-export for backwards compatibility
export type { EmailLogEntry, QueuedEmailEntry } from "@/types/email-management.types";
