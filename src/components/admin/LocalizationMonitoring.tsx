...
export const LocalizationMonitoring: React.FC = React.memo(() => {
    ...
    try {
      ...
      if (analyticsError) {
        ...
        const localeStats = Array.from(localeMap.values()).map((stats) => ({
          ...
          cacheHitRate: (stats.cacheHitRate / stats.requests) * 100,
        }));
        ...
        setData({
          ...
          errorRate: ((errors?.length || 0) / totalRequests) * 100,
...
LocalizationMonitoring.displayName = "LocalizationMonitoring";
