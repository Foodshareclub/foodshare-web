...
- [Project Structure](./01-getting-started/PROJECT_STRUCTURE.md) - Codebase layout

## Development

- [Architecture](./02-development/ARCHITECTURE.md) - System design
- [Database Schema](./02-development/DATABASE_SCHEMA.md) - Data structure
- [Development Guide](./02-development/DEVELOPMENT_GUIDE.md) - Workflows
- [Style Guide](./02-development/STYLE_GUIDE.md) - Code conventions
- [Testing Guide](./02-development/TESTING_GUIDE.md) - QA and testing
- [Performance Guide](./02-development/PERFORMANCE_GUIDE.md) - Optimization
- [i18n Guide](./02-development/I18N_GUIDE.md) - Internationalization

## Features

- [Admin](./03-features/admin/README.md) - Admin dashboard
- [Authentication](./03-features/authentication/README.md) - Auth and OAuth
- [Edge Functions](./03-features/edge-functions/README.md) - Serverless functions
...
- [Tech Stack](./context/TECH_STACK.md) - Technologies used
