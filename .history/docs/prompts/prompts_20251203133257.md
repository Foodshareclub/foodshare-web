...
### Refactoring
    ...
    - Refactor the codebase to use the best bleeding edge practices
    - Refactor the codebase to use the latest packages compatible with the stack
    - Is it transperent  fully? [Image #1] also when the modal window pops the Show map button must get blured as the rest of the background gets blured respectevely.
## Propmt management
