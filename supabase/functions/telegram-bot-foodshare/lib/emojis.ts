/**
 * Emoji Constants for FoodShare Telegram Bot
 * Centralized emoji definitions for consistent usage across messages
 */
...
// Progress & Steps
export const STEP_1 = "1️⃣";
export const STEP_2 = "2️⃣";
export const STEP_3 = "3️⃣";
export const CHECK_EMPTY = "🔘";
export const CHECK_FILLED = "🔵";
