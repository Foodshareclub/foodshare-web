-- Migration: Add secondary sort key to get_nearby_posts RPCs for deterministic pagination
-- Purpose: Fix infinite scroll bug by making offset pagination stable for identical distances.
...
BEGIN
    ...
    ORDER BY distance_meters ASC, p.id DESC
    LIMIT p_limit
    OFFSET p_offset;
END;
$$;
